...
- *Coverage status of other domains:* VAT refund (~42, only ~50 countries run tourist schemes), ATM fees (16, operator-fee amounts volatile), tipping (53, subjective) are complete-by-design or low-confidence. Customs (42) is the remaining genuine gap but is dense per-country legal data (duty-free allowances, prohibited items) best expanded in a dedicated reviewed effort.
