...
**Phase 7 — New data domains** *(queued)*
- Per the product decision (Jun 2026), the next net-new authoring effort adds four domains across the 202 countries, in priority order: **Languages & phrases → Public holidays → eSIM & mobile data → Safety & advisories** (tap-water potability and LGBTQ+/solo-traveller safety fold into the last). Same best-effort/dated/disclaimed bar; safety/health rows carry the strong disclaimers those domains already use.
