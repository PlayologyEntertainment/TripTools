...
- *Coverage status of remaining domains:* VAT refund (~42, only ~50 countries run tourist schemes), ATM fees (16, operator-fee amounts volatile), tipping (53, subjective) are complete-by-design or low-confidence and left as-is. **All other domains — Power Plug, Emergency, Visa, Vaccination, Customs, International Driving Permit, Driving Rules and Quiet Hours — are at full 202-country coverage.**
